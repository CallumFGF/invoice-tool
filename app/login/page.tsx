...
export const metadata = { title: 'Sign in — Childminder Invoice' };
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 p-6 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-bold tracking-tight">Childminder Invoice</h1>
        <p className="max-w-xs text-sm text-muted-foreground">
          Sign in to access your families and invoices from any device.
        </p>
      </div>
